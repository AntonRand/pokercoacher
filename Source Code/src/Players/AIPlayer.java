...
public class AIPlayer extends Player {
     ...
     */
    public AIPlayer(String forename, String surname, int chipBalance, int guiPosition, int difficulty) {
            ...
            if (difficulty == 0) {
                ...
                //If post-flop.
                    ...
                    if (randomNumber <= 70) {
                        //Take the easy method 70% of the time.
                        super.setPlayersTurn(false);
                        return easyAction(communityCards, amountToCall, bigBlind);
                    } else if (randomNumber <= 90) {
                        //Take the normal method 20% of the time.
                        super.setPlayersTurn(false);
                        return normalAction(communityCards, amountToCall, bigBlind);
                    } else {
                        //Call 10% of the time.
                        super.setPlayersTurn(false);
                        return betAmount(amountToCall - super.getAmountCalled());
                ...
                //If post-flop
                    if (randomNumber <= 80) {
                        //Take the hard method 80% of the time.
                        super.setPlayersTurn(false);
                        return hardAction(communityCards, amountToCall, bigBlind);
                    } else if (randomNumber <= 95) {
                        //Take the normal method 15% of the time.
                        super.setPlayersTurn(false);
                        return normalAction(communityCards, amountToCall, bigBlind);
    ...
    public int hardPreflop(int amountToCall, int bigBlind) {
        ...
        if (evaluateHoleCardsHard() || super.getAmountCalled() > 0) {
            return hardAction(new ArrayList<Card>(), amountToCall, bigBlind);
        } else {
            return 0;
        }
    }

    public int easyAction(ArrayList<Card> communityCards, int amountToCall, int bigBlind) {
    ...
    public int normalAction(ArrayList<Card> communityCards, int amountToCall, int bigBlind) {
    ...
    public int hardAction(ArrayList<Card> communityCards, int amountToCall, int bigBlind) {
        //Work out the percentages.
